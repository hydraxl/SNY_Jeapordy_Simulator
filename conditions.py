...
deterministic = framework.Condition(strategy_assigner=all_highest, diffuculty_scale_assigner=all_easy)

# Chooses questions by greed with medium difficulty
medium_greedy = framework.Condition(strategy_assigner=all_greedy, diffuculty_scale_assigner=all_medium)

# Chooses questions by greed with hard difficulty
hard_greedy = framework.Condition(strategy_assigner=all_greedy, diffuculty_scale_assigner=all_hard)

# Chooses highest point value questions with medium difficulty
medium_highest = framework.Condition(strategy_assigner=all_highest, diffuculty_scale_assigner=all_medium)

# Chooses highest point value questions with hard difficulty
hard_highest = framework.Condition(strategy_assigner=all_highest, diffuculty_scale_assigner=all_hard)

# Question choice is random and weighted by point value, easy difficulty
easy_by_points = framework.Condition(strategy_assigner=all_by_points, diffuculty_scale_assigner=all_easy)

# Question choice is random and weighted by point value, medium difficulty
medium_by_points = framework.Condition(strategy_assigner=all_by_points, diffuculty_scale_assigner=all_medium)

# Question choice is random and weighted by point value, hard difficulty
hard_by_points = framework.Condition(strategy_assigner=all_by_points, diffuculty_scale_assigner=all_hard)

# Question choice is random, easy difficulty
easy_random = framework.Condition(strategy_assigner=all_base_strat, diffuculty_scale_assigner=all_easy)

# Question choice is random, medium difficulty
medium_random = framework.Condition(strategy_assigner=all_base_strat, diffuculty_scale_assigner=all_medium)

# Question choice is random, hard difficulty
hard_random = framework.Condition(strategy_assigner=all_base_strat, diffuculty_scale_assigner=all_hard)

# Question choice is random weighted by greed, medium difficulty
medium_random_greedy = framework.Condition(strategy_assigner=all_greedy_weighted, diffuculty_scale_assigner=all_medium)

# Question choice is random weighted by greed, hard difficulty
hard_random = framework.Condition(strategy_assigner=all_greedy_weighted, diffuculty_scale_assigner=all_hard)
